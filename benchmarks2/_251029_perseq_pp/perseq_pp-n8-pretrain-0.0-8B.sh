...
# $$OUTPUT_DIR_PREFIX=/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks2/_251029_perseq_pp/logs.v1-n8-pretrain-0.0-8B
# $$FOLDER_SEPARATOR=1
...
# bash /mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks2/_251029_perseq_pp/salloc_srun.pp_8b.v2.sh --config /mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks2/_251029_perseq_pp/perseq_pp-n8-pretrain-0.0-8B.sh
...
# 512k tbs=8 node=16
    ...
    16   1  4 524288    wlbllm           4  2  8 'some_comment'  'EXPERIMENT_SCHEDULE_PRIORITY=100'
...
# 128k tbs=128 node=32
    ...
    32   8  8 131072    wlbllm           4  2  8 'some_comment'  'EXPERIMENT_SCHEDULE_PRIORITY=100'
...
# 512k tbs=16 node=32
    ...
    32   2  4 524288    wlbllm           4  2  8 'some_comment'  'EXPERIMENT_SCHEDULE_PRIORITY=100'
# >>>
