...
# root_path = "/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks2/_251028_flexsp/logs.v1-34B-s15"
# root_path = "/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks2/_251028_flexsp/logs.v1/logs.v1-8B"
root_path = "/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks2/_251028_flexsp/logs.v2/logs.v1-8B"
...
ilp_groups_best.columns = ['model_size', 'num_tokens', 'ratio', 'nodes', 'total_batch_size', 'dataset', 'average_duration', 'average_duration_list', 'pp_size_list', 'cp_size_list', 'num_microbatch_list', 'batch_size_list']

ilp_groups_best['config_list'] = ilp_groups_best.apply(
    lambda x: [
...
ilp_groups_best['config_list'] = ilp_groups_best['config_list'].apply(
    lambda x: sorted(x, key=lambda x: x[-1])
)
ilp_groups_best['best_config'] = ilp_groups_best['config_list'].apply(
    lambda x: sorted(x, key=lambda x: x[-1])[0]
)
ilp_groups_best = ilp_groups_best.drop(columns=['average_duration_list', 'pp_size_list', 'cp_size_list', 'num_microbatch_list', 'batch_size_list'])
ilp_groups_best
