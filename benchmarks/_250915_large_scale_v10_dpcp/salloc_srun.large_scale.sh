...
export OUTPUT_DIR_PREFIX="/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks/_250915_large_scale_v10_dpcp/logs.v2-shard3-prolong-70b"
...
for config in \
    ...
    for tolerance_factor in 0.1 0.2; do
        export MODE=d2
