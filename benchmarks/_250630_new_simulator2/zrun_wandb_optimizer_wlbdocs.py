...
def run_wlbdocs_altered_experiment(
    max_ctx_length,
    ...
    run_name = f"{sample_name}_ctx_{ctx_str}_gpu{num_total_devices}_atworker{max_num_workers_attnserver}"
...
if __name__ == "__main__":
    for max_length in [64, 128, 256, 512, 1024]:
        run_wlbdocs_altered_experiment(
            max_ctx_length=max_length * tm.K,
