...
import json
import os
root = "/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks/_250912_d2cp_dist/logs.v1-tolerance-sweep"
root2 = "/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks/_250912_d2cp_dist/logs.v1-sweep-prolong"
...
for folder in a:
    ...
    name = folder[27:]
    groups = name.split("-")
    mode, cp_size, nodes, batch_size, num_tokens, tolerance_factor = groups
    print(f"{name}: {average_duration:.2f}ms")
    row = dict(
        name=name,
        mode=mode,
