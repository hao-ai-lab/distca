...
export JOBID=1106028
export HEAD_NODE_IP=fs-mbz-gpu-032
# export NNODES=4
...
export OUTPUT_DIR_PREFIX="/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks3/_251120_cudagraph/logs.v1"
...
# export EXEC_FILE_NAME="test_e2e_combined.py"
export EXEC_FILE_NAME="test_e2e_combined_allgather.py"
