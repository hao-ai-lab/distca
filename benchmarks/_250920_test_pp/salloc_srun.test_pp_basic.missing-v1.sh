...
#     n bs mb t       mode  cp pp tp comment )
    "16  1 8 131072     d2  8  2   8  'd2-pretrain'  "
    "16  2 4 131072     d2  8  2   8  'd2-pretrain'  "
    "16  1 8 131072     d2  2  8   8  'd2-pretrain'  "
    "16  1 8 131072 wlbllm  8  2   8  'wlbllm-pretrain'  " # 
    "16  2 4 131072 wlbllm  4  4   8  'wlbllm-pretrain'  " # 
    "16  1 8 131072 wlbllm  2  4   8  'wlbllm-pretrain'  " # 
...
#    n bs mb t       mode  cp pp tp comment )
    # "32  4 8 131072     d2 16  2   8  'd2-pretrain'  "
    # "32  2 16 131072    d2 16  2   8  'd2-pretrain'  "
    # "32  4 8 131072     d2 8   4   8  'd2-pretrain'  "
    # "32  2 16 131072    d2 8   4   8  'd2-pretrain'  "
    # "32  4 8 131072 wlbllm 16  2   8  'wlbllm-pretrain'  " # 
    # "32  2 16 131072 wlbllm 16  2   8  'wlbllm-pretrain'  " # 
    # "32  8 4 131072 wlbllm 16  2   8  'wlbllm-pretrain'  " # 
    # "32  4 8 131072 wlbllm  8  4   8  'wlbllm-pretrain'  " # 
...
#     n bs mb t       mode  cp pp tp comment )
    "16  1 4 262144     d2  8  2   8  'd2-pretrain'  "
    "16  2 2 262144     d2  8  2   8  'd2-pretrain'  "
    "16  1 4 262144     d2  2  8   8  'd2-pretrain'  "
    "16  1 4 262144 wlbllm  8  2   8  'wlbllm-pretrain'  " # 
    "16  2 2 262144 wlbllm  4  4   8  'wlbllm-pretrain'  " # 
    "16  1 4 262144 wlbllm  2  4   8  'wlbllm-pretrain'  " # 
...
# --- OOM with PP. Reuse the speedup from DPCP Only?
# #    n bs mb t       mode  cp pp tp comment )
#     "8  1 2 524288     d2  4  2   8  'd2-pretrain'  "
#     "8  1 2 524288 wlbllm  2  2   8  'wlbllm-pretrain'  " # 
#     "8  2 1 524288     d2  8  1   8  'd2-pretrain'  "
#     "8  1 2 524288 wlbllm  4  2   8  'wlbllm-pretrain'  " # 
...
#     n bs mb t       mode  cp pp tp comment )
    "16  1 4 524288     d2  8  2   8  'd2-pretrain'  "
    "16  1 4 524288 wlbllm  2  4   8  'wlbllm-pretrain'  " # 
    "16  2 2 524288     d2  8  2   8  'd2-pretrain'  "
    "16  1 4 524288     d2  2  8   8  'd2-pretrain'  "
    "16  1 4 524288 wlbllm  8  2   8  'wlbllm-pretrain'  " # 
    "16  2 2 524288 wlbllm  4  4   8  'wlbllm-pretrain'  " # 
...
# #    n bs mb t       mode  cp pp tp comment 
#     "32 1 2 524288    d2   16  2  8  'd2 subopt-mem - need 4GB nvshmem buffer to not get stuck but still get oom.'  " # 
#     "32 1 2 524288 wlbllm  8  2  8  'wlbllm subopt-mem'  " # 
#     "32 1 2 524288 wlbllm  4  2  8  'wlbllm subopt-mem'  " # 
