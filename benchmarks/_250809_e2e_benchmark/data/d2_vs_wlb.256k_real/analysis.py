...
file_groups = {
    "D2 (BS8) vs WLB DP1CP8 (BS8) [256K]": {
        "d2": "group3.d2.dpcp8.bs4.json",
        "wlb": "group1.wlbllm.dp1cp8.bs4.json",
    },
    "D2 (BS8) vs WLB DP2CP4 (BS8) [256K]": {
        "d2": "group3.d2.dpcp8.bs4.json",
        "wlb": "group2.wlbllm.dp2cp4.bs4.json",
    },
    "D2 (BS8) vs WLB DP4CP2 (BS8) [256K]": {
        "d2": "group3.d2.dpcp8.bs4.json",
        "wlb": "group3.wlbllm.dp4cp2.bs4.json",
    },
    "D2 (BS8) vs WLB DP8CP1 (BS8) [256K]": {
        "d2": "group4.d2.dpcp8.bs4.json",
        "wlb": "group4.wlbllm.dp8cp1.bs4.json",
    },
    "D2 (BS8) vs WLB DP2CP4 (BS8) (nsample=50) [256K]": {
        "d2": "group5.d2.dpcp8.bs4.sample50.json",
        "wlb": "group5.wlbllm.dp4cp2.bs4.sample50.json",
    },
...
for i, (name, file_group) in enumerate(file_groups.items()):
    ...
    diff_d2_wlb = [durations_wlb[i] - durations_d2[i] for i in range(
        min(len(durations_d2), len(durations_wlb))
    )]
    speedup_d2_wlb = [durations_wlb[i] / durations_d2[i] for i in range(
        min(len(durations_d2), len(durations_wlb))
    )]
