...
seq_len = "128k (upsample = 8, elongate = 1, filter = 64k, filter_ratio = 0.1)"
d2_path       = f"{pwd}/../data/d2_vs_base.128kup32filter64k/benchmark.20250816_191349.d2.json"
baseline_path = f"{pwd}/../data/d2_vs_base.128kup32filter64k/benchmark.20250816_191822.baseline.json"
