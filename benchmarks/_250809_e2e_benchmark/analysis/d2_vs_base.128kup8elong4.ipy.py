...
seq_len = "128k (upsample = 8, elongate = 4)"
d2_path       = f"{pwd}/../data/d2_vs_base.128kup8elong4/benchmark.20250816_182248.d2.json"
baseline_path = f"{pwd}/../data/d2_vs_base.128kup8elong4/benchmark.20250816_174333.baseline.json"
