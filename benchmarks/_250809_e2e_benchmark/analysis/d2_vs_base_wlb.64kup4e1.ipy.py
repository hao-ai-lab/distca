...
seq_len = "64k (upsample = 8, elongate = 1)"
data_dir = f"{pwd}/../data/d2_vs_base_wlb.64kup4e1"

d2_path       = f"{data_dir}/benchmark.20250818_200843.d2.json"
baseline_path = f"{data_dir}/benchmark.20250818_201134.baseline.json"
wlbllm_path   = f"{data_dir}/benchmark.20250818_200520.wlbllm.json"
