...
#    n  bs  mb    t       mode  cp  pp tp     comment        env_var
    # 32   1   16   524288     d2    32   1   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=0,EXPERIMENT_NVSHMEM_BUFFER_SIZE_GB=2,EXPERIMENT__STUCK=1'  # 🔴 This will stuck at L18. See `24_101245.d2-n32-t524288-b1-mb16-cp32tp8pp1-codellama_CodeLlama-34b-hf`
...
# ---------------- 64 nodes ----------------
#   n   bs   mb     t       mode   cp   pp  tp     comment        env_var
    64   8    8   131072     d2    32   2   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=0'
    ...
    64   4   16   131072     d2    16   4   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=0'
    64   4   16   131072     wlbllm    16   4   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=0,EXPERIMENT__STATUS=SUCCESS'

    64   32   1   262144     d2    64   1   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=0'
    ...
    64   1   16   262144     d2    32   2   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=0'
    64   1   16   262144     wlbllm    32   2   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=0'
    64   2   8    262144     d2    32   2   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=0'
    64   2   8    262144     wlbllm    32   2   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=0'

    64   2   16   262144     d2    32   2   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=0'
    64   2   16   262144     wlbllm    32   2   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=0'
