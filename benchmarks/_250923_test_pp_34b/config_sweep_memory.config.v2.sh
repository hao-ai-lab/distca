...
#   n   bs   mb     t       mode   cp   pp  tp     comment        env_var
    # 32   1   4   393216     d2    16   2   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=1,MAX_SAMPLE_ID=1,MIN_TOLERANCE_FACTOR=0.25,EXPERIMENT__DEBUG=1,OUTPUT_DIR_SUFFIX_ADDON=-debug-tol0.25-after-tune'
    # 32   1   4   393216     d2    16   2   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=1,MAX_SAMPLE_ID=1,MIN_TOLERANCE_FACTOR=0.35,EXPERIMENT__DEBUG=1,OUTPUT_DIR_SUFFIX_ADDON=-debug-tol0.35-after-tune'
    # 32   1   4   393216     d2    16   2   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=1,MAX_SAMPLE_ID=1,MIN_TOLERANCE_FACTOR=0.05,EXPERIMENT__DEBUG=1,OUTPUT_DIR_SUFFIX_ADDON=-debug-tol0.05-after-tune'
    # 32   1   16   393216     d2    8   4   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=1,MAX_SAMPLE_ID=1,MIN_TOLERANCE_FACTOR=0.05,EXPERIMENT__DEBUG=1,OUTPUT_DIR_SUFFIX_ADDON=-debug-tol0.05-after-tune,EXPERIMENT_NVSHMEM_BUFFER_SIZE_GB=1.5,EXPERIMENT_REPEAT_TIMES=2'
    # 32   1   4   393216     d2    16   2   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=1,MAX_SAMPLE_ID=1,MIN_TOLERANCE_FACTOR=0.05,EXPERIMENT__DEBUG=1,OUTPUT_DIR_SUFFIX_ADDON=-debug-tol0.05-after-tune,EXPERIMENT_NVSHMEM_BUFFER_SIZE_GB=1.5,CUDA_SCALE_LAUNCH_QUEUES=4'
    # 32   1   4   393216   wlbllm  4   4   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=1,MAX_SAMPLE_ID=1,EXPERIMENT__DEBUG=1,OUTPUT_DIR_SUFFIX_ADDON=-debug-wlbllm'
    # 32   1   16   393216     d2    16   2   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=1,MAX_SAMPLE_ID=1,MIN_TOLERANCE_FACTOR=0.05,EXPERIMENT__DEBUG=1,OUTPUT_DIR_SUFFIX_ADDON=-debug-tol0.05-after-tune,EXPERIMENT_NVSHMEM_BUFFER_SIZE_GB=1.5,EXPERIMENT_REPEAT_TIMES=2'
    # 32   1   4   393216   wlbllm  16   2   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=1,MAX_SAMPLE_ID=1,EXPERIMENT__DEBUG=1,OUTPUT_DIR_SUFFIX_ADDON=-debug-wlbllm'
