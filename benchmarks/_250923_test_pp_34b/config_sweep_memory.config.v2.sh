...
# ---------------- 512k 32 node tbs=4 ----------------
#   n   bs   mb     t       mode   cp   pp  tp     comment        env_var
    32   4   1   524288     d2    32   1   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=0,EXPERIMENT_SCHEDULE_PRIORITY=5'
...
# ---------------- 512k 16 node tbs=2 ----------------
#   n   bs   mb     t       mode   cp   pp  tp     comment        env_var
    16   2    1   524288     d2    16   1   8  'd2-pretrain'  'EXPERIMENT_ADD_SELECTIVE_CKPT=1,ENABLE_NSYS=0,EXPERIMENT_SCHEDULE_PRIORITY=5'
