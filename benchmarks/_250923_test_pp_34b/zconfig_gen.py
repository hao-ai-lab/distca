...
rows = []
# for seq_len in [128 * K, 256 * K, 512 * K]:
for seq_len in [128 * K]:
    for nnodes in [16, 32, 64]:
        _ratios = {
            128 * K: [2],
            # 256 * K: [2],
            # 512 * K: [1, 2],
