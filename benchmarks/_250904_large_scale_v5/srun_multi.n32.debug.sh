...
export EXPERIMENT_NVSHMEM_BUFFER_SIZE_GB=3
export EXPERIMENT_LOG_MEMORY_USAGE=0 
export NUM_LAYERS=4
export MAX_SAMPLE_ID=2

export SHOULD_NSYS_PROFILE=1

export nnodes=32
export ngpus=256
export head_node=fs-mbz-gpu-064
export jobid=681795

for NNODES in 32; do
    # for NUM_TOKENS in 1048576 524288 262144 131072; do
    # for NUM_TOKENS in 1048576; do
    # for NUM_TOKENS in 131072 262144 524288; do
