...
# folder = "/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks/_250918_large_scale_v11_dpcp/logs.v1-pretrain-8b/20250918_005139.job-800526.wlbllm-cp32-n32-b16-t131072/mem-log"
folder = "/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks/_250918_large_scale_v11_dpcp/logs.v1-pretrain-8b/20250918_005257.job-800526.wlbllm-cp16-n32-b16-t131072/mem-log"
# folder = "/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks/_250918_large_scale_v11_dpcp/logs.v1-pretrain-8b/20250918_004531.job-800526.d2-cp1-n32-b16-t131072-normal/mem-log"
...
# %%
import pandas as pd
df = pd.DataFrame(next(iter(mem_data.values())))
df['allocated_cur'] = df['allocated_cur'].astype(float).apply(lambda x: x / 1024 if x > 1024 else x).round(2)
df['allocated_peak'] = df['allocated_peak'].astype(float).apply(lambda x: x / 1024 if x > 1024 else x).round(2)
df['total_alloc'] = df['total_alloc'].astype(float).apply(lambda x: x / 1024 if x > 1024 else x).round(2)
df['pynvml_gpu_memory_usage'] = df['pynvml_gpu_memory_usage'].astype(float).apply(lambda x: x / 1024 if x > 1024 else x).round(2)
