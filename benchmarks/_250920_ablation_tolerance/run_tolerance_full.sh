...
export OUTPUT_DIR_PREFIX="/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks/_250920_ablation_tolerance/logs.v3-tolerance-full"
...
for config in "${configs[@]}"; do
    ...
    export OUTPUT_DIR_SUFFIX_ADDON="-tol${tolerance_factor}-m${MODEL_PATH_normalized}"
