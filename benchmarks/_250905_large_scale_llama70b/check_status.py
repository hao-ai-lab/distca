...
import subprocess
a = subprocess.check_output(['ls', 'logs/']).decode().split('\n')
...
front_columns = ['gid', 'reason', 'is_finished', 'exp_total_time', 'mode', 'CP_SIZE', 'layers', 'toks', 'bs', 'model', 'nodes', "EXPERIMENT_ADD_SELECTIVE_CKPT", "EXPERIMENT_SHOULD_RESEND_QKV", "exp", 'it', 'avg_duration', 'max_mem', ]
