...
#     "1 1 1 262144 4 32" \
#     "1 1 1 524288 8 32" \
# "deepseek-ai/DeepSeek-R1-Distill-Llama-8B 64000 32 1 1 8 131072  2   16" \
#              "codellama/CodeLlama-34b-hf 131072 48 1 1 2 131072  2   8" \
#              "codellama/CodeLlama-34b-hf 131072 48 1 1 4 131072  2   16" \
# "deepseek-ai/DeepSeek-R1-Distill-Llama-8B 64000 4 1 1 4 524288  2   16" \
# "deepseek-ai/DeepSeek-R1-Distill-Llama-8B 64000 4 1 1 2 524288  16   8" \
...
for config in \
    ...
    # for tolerance_factor in 0.0 0.05 0.10 0.15 0.20 0.25 0.30 0.40 0.5 0.8 1.0 2.0 8.0 16.0; do
    # for tolerance_factor in 0.05 0.20 0.5 1.0 2.0 16.0; do
    for tolerance_factor in 0.0 0.05 0.01 0.03 0.02 0.04    ; do
        export MODE=d2
