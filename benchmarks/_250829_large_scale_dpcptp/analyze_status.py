...
sample_columns = [col for col in df_display.columns if col.startswith("sample[")]
...
# Sort and reorder columns to put key columns first
...
front_columns = ['gid', 'nnodes', 'NUM_TOKENS', 'BATCH_SIZE', 'MODE_EMOJI', 'total_time']
