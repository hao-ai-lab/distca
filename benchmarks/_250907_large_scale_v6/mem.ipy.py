...
root_dir = "/mnt/weka/home/yonghao.zhuang/jd/d2/benchmarks/_250907_large_scale_v6/logs.v2-large_scale"
...
for name in names:
    ...
    plt.legend(ncol=8, bbox_to_anchor=(1.05, 1), loc='upper left')
    plt.title(name)
    plt.xlabel('Step')
