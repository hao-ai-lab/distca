...
EXPERIMENT_DEBUG_SET_METADATA_TRANSFER_SIZE_TO_0=0 SHOULD_RESEND_QKV=1 EXPERIMENT_WARMUP_TIMEOUT_SEC=300 EXPERIMENT_WARMUP_TIMES=3 EXPERIMENT_REPEAT_TIMES=1 EXPERIMENT_NVSHMEM_BUFFER_SIZE_GB=6 EXPERIMENT_LOG_MEMORY_USAGE=0 BATCH_SIZE=2 NUM_LAYERS=4 NUM_TOKENS=131072 ELONGATE_FACTOR=1 MAX_SAMPLE_ID=1 bash test_e2e_combined.onesrun.sh


EXPERIMENT_DEBUG_SET_METADATA_TRANSFER_SIZE_TO_0=0 SHOULD_RESEND_QKV=1 EXPERIMENT_WARMUP_TIMEOUT_SEC=300 EXPERIMENT_WARMUP_TIMES=3 EXPERIMENT_REPEAT_TIMES=1 EXPERIMENT_NVSHMEM_BUFFER_SIZE_GB=6 EXPERIMENT_LOG_MEMORY_USAGE=0 BATCH_SIZE=1 NUM_LAYERS=32 NUM_TOKENS=1048576 ELONGATE_FACTOR=16 MAX_SAMPLE_ID=1 bash test_e2e_combined.onesrun.sh
